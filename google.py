...
class GoogleQuote(Quote):
  ...
  def __init__(self,symbol,start_date,end_date=datetime.date.today().isoformat()):
    ...
    csv = ur.urlopen(url_string).readlines()
    csv.reverse()
...
if __name__ == '__main__':
  ...
  q = GoogleQuote('aapl','2010-01-01','2016-06-01') # download Oracle data for February 2011
  q.write_csv('601318.csv')                           # save it to disk
